...
const AddIcon = ({sx, width, height}) => {
    return (
        <>
            <svg aria-label="Load more comments" style={sx} color="#262626" fill="#262626" height={height} role="img"
                ...
                <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                      x1="7.001" x2="17.001" y1="12.005" y2="12.005"></line>
                <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                      x1="12.001" x2="12.001" y1="7.005" y2="17.005"></line>
            </svg>
        </>
    )
}
