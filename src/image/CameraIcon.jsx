...
const CameraIcon = ({sx, width, height}) => {
    return (
        <div>
            <svg aria-label="New story" className={sx} color="#262626" fill="#262626" height={height} role="img"
                 viewBox="0 0 24 24" width={width}>
                <circle cx="12" cy="13.191" fill="none" r="4.539" stroke="currentColor" strokeLinejoin="round"
