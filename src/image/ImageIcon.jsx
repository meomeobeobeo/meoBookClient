...
const ImageIcon = ({sx, width, height}) => {
    return (
        <>
            <svg aria-label="Add Photo or Video" style={sx} color="#262626" fill="#262626" height={height} role="img"
                 viewBox="0 0 24 24" width={width}>
                <path d="M6.549 5.013A1.557 1.557 0 108.106 6.57a1.557 1.557 0 00-1.557-1.557z"
