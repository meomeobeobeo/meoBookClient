...
import { Paper, Typography, TextField, Button,  Avatar, Stack, IconButton, ButtonGroup, } from '@mui/material'
    ...
    <Box bgcolor='white' p={3} sx={{
      ...
      <form onSubmit={handleSubmit}  >
        ...
        <ButtonGroup fullWidth variant="contained" color='primary'  >
          <Button type="submit" onClick={() => { setOpenPopup(!openPopup) }}>Submit</Button>
