                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    <Grid container spacing={2} align="center"   >
                        {isSignUp && (
                            <>
                                <Grid item xs={12} >
                                    <TextField name='firstName' label='First Name' variant='outlined' onChange={handleChange} type="text" autoFocus fullWidth />
                                </Grid>
                                <Grid item xs={12} >
                                    <TextField name='lastName' label='Last Name' variant='outlined' onChange={handleChange} type="text" fullWidth />
                        ...
                        <Input name='email' label="Email Address" variant='outlined' onChange={handleChange} half type='email' />
                        <Input name='password' label="Password" variant='outlined' onChange={handleChange} half handleShowPassword={handleShowPassword} type={showPassword ? 'text' : 'password'} />
...

                        {
                            isSignUp && (
                                <>
                                    <Input name='confirmPassword' label="Repeat Password" variant='outlined' onChange={handleChange} handleShowPassword={handleShowPassword} type={showPassword ? 'text' : 'password'} />
                    ...
                    <GoogleLogin
                        clientId='1054340077074-ii0gr96blkp0o9fnp8a1uej8hg7t0ct0.apps.googleusercontent.com'
                        render={renderProps => (
                            <Button onClick={renderProps.onClick} color='primary' variant='contained' fullWidth className={classes.googleButton} disabled={renderProps.disabled}>Login with Google</Button>
                        )}
                    ...
                    <Button type="submit" fullWidth variant='contained' color='primary' className={classes.submit} sx={{ marginTop: '12px' }}>{isSignUp ? 'Sign Up' : 'Sign In'}</Button>
